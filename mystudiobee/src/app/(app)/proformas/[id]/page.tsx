...
import { QuoteEditor } from "../../quotes/quote-editor";
...
export default async function ProformaDetailPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  if (!doc || doc.type !== "proforma") notFound();
        ...
        <div className="animate-in-page mx-auto max-w-3xl space-y-4">
          ...
          <QuoteEditor
            ...
            doc={{
              ...
              doc_date: (doc as Record<string, unknown>).doc_date as string | null | undefined,
              valid_until: (doc as Record<string, unknown>).valid_until as string | null | undefined,
            }}
          />
        </div>
      </div>
